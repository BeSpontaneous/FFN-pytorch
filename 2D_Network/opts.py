...
# ========================= Model Configs ==========================
parser.add_argument('--arch_file', type=str, default="resnet_TSM_mask")
parser.add_argument('--arch', type=str, default="BNInception")
parser.add_argument('--num_segments', type=int, default=16)
parser.add_argument('--num_segments_H', type=int, default=16)
parser.add_argument('--num_segments_M', type=int, default=8)
parser.add_argument('--num_segments_L', type=int, default=4)
...
parser.add_argument('--lr_steps_dynamic', default=[50, 100], type=float, nargs="+",
                    metavar='LRSteps', help='epochs to decay learning rate by 10')
...
parser.add_argument('--freeze_tune', default='', type=str, metavar='PATH')
parser.add_argument('--load_fc', default='', type=str)
...
parser.add_argument('--ckpt_log',type=str, default='log')
...
parser.add_argument('--model_path', default='exp', type=str)
parser.add_argument('--lambda_act', default=1, type=float, metavar='M', help='momentum')