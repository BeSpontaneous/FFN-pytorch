...
class TSN(nn.Module):
    def __init__(self, arch_file, num_class, num_segments, modality,
    ...
    def _prepare_base_model(self, arch_file, base_model):
        ...
        if 'resnet' in base_model:
            self.base_model = eval(f'ops.backbone.{arch_file}.{base_model}')(True if self.pretrain == 'imagenet' else False, shift='TSM', num_segments=self.num_segments)
            # from .resnet_TSM import resnet50
            # self.base_model = resnet50(True, shift='TSM', num_segments=self.num_segments)
