...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["2d", "c2d", "i3d", "slow", "x3d", "mvit", "uniformer", "uniformer_FFN"]
...
_C.DATA.IMAGE_TEMPLATE_kinetics = "image_{:05d}.jpg"

# The number of frames of the input clip.
_C.DATA.NUM_FRAMES = 8

_C.DATA.NUM_FRAMES_H = 16
_C.DATA.NUM_FRAMES_M = 8
_C.DATA.NUM_FRAMES_L = 4
