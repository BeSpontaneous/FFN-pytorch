...
class CBlock(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.norm1_4 = bn_3d(dim)
        self.norm1_8 = bn_3d(dim)
        self.norm1_16 = bn_3d(dim)
        ...
        self.norm2_4 = bn_3d(dim)
        self.norm2_8 = bn_3d(dim)
        self.norm2_16 = bn_3d(dim)
        mlp_hidden_dim = int(dim * mlp_ratio)
        self.mlp = CMlp(in_features=dim, hidden_features=mlp_hidden_dim, act_layer=act_layer, drop=drop)
        
        self.adaconv_4 = nn.Conv3d(dim, dim, (1, 1, 1), (1, 1, 1), (0, 0, 0), groups=dim, bias=False)
        self.adaconv_8 = nn.Conv3d(dim, dim, (1, 1, 1), (1, 1, 1), (0, 0, 0), groups=dim, bias=False)
        self.adaconv_16 = nn.Conv3d(dim, dim, (1, 1, 1), (1, 1, 1), (0, 0, 0), groups=dim, bias=False)
    ...
    def forward(self, x_4, x_8, x, training=True):
        if training == True:
            ...
            x_4 = x_4 + self.pos_embed(x_4)
            x_4 = x_4 + self.drop_path(self.conv2(self.attn(self.conv1(self.norm1_4(x_4)))))
            x_4 = x_4 + self.drop_path(self.mlp(self.norm2_4(x_4)))
            
            iden_8 = x_8
            x_8 = self.adaconv_8(x_8)
            x_8 = x_8 + iden_8
            
            x_8 = x_8 + self.pos_embed(x_8)
            x_8 = x_8 + self.drop_path(self.conv2(self.attn(self.conv1(self.norm1_8(x_8)))))
            x_8 = x_8 + self.drop_path(self.mlp(self.norm2_8(x_8)))
            ...
            x = x + self.drop_path(self.conv2(self.attn(self.conv1(self.norm1_16(x)))))
            x = x + self.drop_path(self.mlp(self.norm2_16(x)))
            ...
            if x_4 is not None:
                ...
                x = x_4 + self.pos_embed(x_4)
                x = x + self.drop_path(self.conv2(self.attn(self.conv1(self.norm1_4(x)))))
                x = x + self.drop_path(self.mlp(self.norm2_4(x)))
            elif x_8 is not None:
                iden_8 = x_8
                x_8 = self.adaconv_8(x_8)
                x_8 = x_8 + iden_8
            
                x = x_8 + self.pos_embed(x_8)
                x = x + self.drop_path(self.conv2(self.attn(self.conv1(self.norm1_8(x)))))
                x = x + self.drop_path(self.mlp(self.norm2_8(x)))
            else:
                iden_16 = x
                x = self.adaconv_16(x)
                x = x + iden_16
...
class SABlock(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        super().__init__()
        self.pos_embed = conv_3x3x3(dim, dim, groups=dim)
        self.norm1_4 = norm_layer(dim)
        self.norm1_8 = norm_layer(dim)
        self.norm1_16 = norm_layer(dim)
        self.attn = Attention(
            dim,
        ...
        # NOTE: drop path for stochastic depth, we shall see if this is better than dropout here
        self.drop_path = DropPath(drop_path) if drop_path > 0. else nn.Identity()
        self.norm2_4 = norm_layer(dim)
        self.norm2_8 = norm_layer(dim)
        self.norm2_16 = norm_layer(dim)
        mlp_hidden_dim = int(dim * mlp_ratio)
    ...
    def forward(self, x_4, x_8, x, training=True):
        if training == True:
            ...
            x_4 = x_4 + self.pos_embed(x_4)
            B_4, C_4, T_4, H_4, W_4 = x_4.shape
            x_4 = x_4.flatten(2).transpose(1, 2)
            x_4 = x_4 + self.drop_path(self.attn(self.norm1_4(x_4)))
            x_4 = x_4 + self.drop_path(self.mlp(self.norm2_4(x_4)))
            x_4 = x_4.transpose(1, 2).reshape(B_4, C_4, T_4, H_4, W_4)
            ...
            x_8 = x_8 + self.pos_embed(x_8)
            B_8, C_8, T_8, H_8, W_8 = x_8.shape
            x_8 = x_8.flatten(2).transpose(1, 2)
            x_8 = x_8 + self.drop_path(self.attn(self.norm1_8(x_8)))
            x_8 = x_8 + self.drop_path(self.mlp(self.norm2_8(x_8)))
            x_8 = x_8.transpose(1, 2).reshape(B_8, C_8, T_8, H_8, W_8)
            ...
            x = x + self.drop_path(self.attn(self.norm1_16(x)))
            x = x + self.drop_path(self.mlp(self.norm2_16(x)))
            ...
            if x_4 is not None:
                ...
                B, C, T, H, W = x.shape
                x = x.flatten(2).transpose(1, 2)
                x = x + self.drop_path(self.attn(self.norm1_4(x)))
                x = x + self.drop_path(self.mlp(self.norm2_4(x)))
                x = x.transpose(1, 2).reshape(B, C, T, H, W)
            elif x_8 is not None:
                iden_8 = x_8
                ...
                B, C, T, H, W = x.shape
                x = x.flatten(2).transpose(1, 2)
                x = x + self.drop_path(self.attn(self.norm1_8(x)))
                x = x + self.drop_path(self.mlp(self.norm2_8(x)))
                x = x.transpose(1, 2).reshape(B, C, T, H, W)
            else:
                iden_16 = x
...
class SpeicalPatchEmbed(nn.Module):
    ...
    def forward(self, x_4, x_8, x, training=True):
        if training == True:
            B_4, C_4, T_4, H_4, W_4 = x_4.shape
            B_8, C_8, T_8, H_8, W_8 = x_8.shape
            B_16, C_16, T_16, H_16, W_16 = x.shape
            x_4 = self.proj(x_4)
            x_8 = self.proj(x_8)
            x = self.proj(x)
            B_4, C_4, T_4, H_4, W_4 = x_4.shape
            ...
            x_8 = self.norm_8(x_8)
            x = self.norm_16(x)
            x_4 = x_4.reshape(B_4, T_4, H_4, W_4, -1).permute(0, 4, 1, 2, 3).contiguous()
            x_8 = x_8.reshape(B_8, T_8, H_8, W_8, -1).permute(0, 4, 1, 2, 3).contiguous()
            x = x.reshape(B_16, T_16, H_16, W_16, -1).permute(0, 4, 1, 2, 3).contiguous()
...
class Uniformer_FFN(nn.Module):
        ...
        if split:
            ...
            self.blocks4 = nn.ModuleList([
                SABlock(
                    ...
                    drop=drop_rate, attn_drop=attn_drop_rate, drop_path=dpr[i+depth[0]+depth[1]+depth[2]], norm_layer=norm_layer)
            for i in range(depth[3])])
        self.norm_4 = bn_3d(embed_dim[-1])
        self.norm_8 = bn_3d(embed_dim[-1])
        self.norm_16 = bn_3d(embed_dim[-1])
    ...
    def get_pretrained_model(self, cfg):
        if cfg.UNIFORMER.PRETRAIN_NAME:
            print(cfg.UNIFORMER.PRETRAIN_NAME)
            ...
            for k, v in new_state_dict.items():
                ...
                if (k.replace('_4', '') in checkpoint):
                    if checkpoint[k.replace('_4', '')].shape != new_state_dict[k].shape:
                        if len(new_state_dict[k].shape) <= 2:
                            logger.info(f'Ignore: {k}')
                            continue
                        logger.info(f'Inflate: {k}, {checkpoint[k].shape} => {new_state_dict[k].shape}')
                        time_dim = new_state_dict[k].shape[2]
                        checkpoint[k.replace('_4', '')] = self.inflate_weight(checkpoint[k.replace('_4', '')], time_dim)
                    new_state_dict.update({k:checkpoint[k.replace('_4', '')]})
                elif (k.replace('_8', '') in checkpoint):
                    if checkpoint[k.replace('_8', '')].shape != new_state_dict[k].shape:
                        if len(new_state_dict[k].shape) <= 2:
                            logger.info(f'Ignore: {k}')
                            continue
                        logger.info(f'Inflate: {k}, {checkpoint[k].shape} => {new_state_dict[k].shape}')
                        time_dim = new_state_dict[k].shape[2]
                        checkpoint[k.replace('_8', '')] = self.inflate_weight(checkpoint[k.replace('_8', '')], time_dim)
                    new_state_dict.update({k:checkpoint[k.replace('_8', '')]})
                elif (k.replace('_16', '') in checkpoint):
                    if checkpoint[k.replace('_16', '')].shape != new_state_dict[k].shape:
                        if len(new_state_dict[k].shape) <= 2:
                            logger.info(f'Ignore: {k}')
                            continue
                        logger.info(f'Inflate: {k}, {checkpoint[k].shape} => {new_state_dict[k].shape}')
                        time_dim = new_state_dict[k].shape[2]
                        checkpoint[k.replace('_16', '')] = self.inflate_weight(checkpoint[k.replace('_16', '')], time_dim)
                    new_state_dict.update({k:checkpoint[k.replace('_16', '')]})
                elif (k in checkpoint):
                    if checkpoint[k].shape != new_state_dict[k].shape:
                        if len(new_state_dict[k].shape) <= 2:
                            logger.info(f'Ignore: {k}')
                            continue
                        logger.info(f'Inflate: {k}, {checkpoint[k].shape} => {new_state_dict[k].shape}')
                        time_dim = new_state_dict[k].shape[2]
                        checkpoint[k] = self.inflate_weight(checkpoint[k], time_dim)
                    new_state_dict.update({k:checkpoint[k]})

            return new_state_dict
        else:
            return None
        
    def forward_features(self, x_4, x_8, x, training=True):
        if training == True:
            x_4, x_8, x = self.patch_embed1(x_4, x_8, x, True)
            x_4 = self.pos_drop(x_4)
            x_8 = self.pos_drop(x_8)
            x = self.pos_drop(x)
            for i, blk in enumerate(self.blocks1):
                if self.use_checkpoint and i < self.checkpoint_num[0]:
                    x = checkpoint.checkpoint(blk, x)
                else:
                    x_4, x_8, x = blk(x_4, x_8, x, True)
            x_4, x_8, x = self.patch_embed2(x_4, x_8, x, True)
            for i, blk in enumerate(self.blocks2):
                if self.use_checkpoint and i < self.checkpoint_num[1]:
                    x = checkpoint.checkpoint(blk, x)
                else:
                    x_4, x_8, x = blk(x_4, x_8, x, True)
            x_4, x_8, x = self.patch_embed3(x_4, x_8, x, True)
            for i, blk in enumerate(self.blocks3):
                if self.use_checkpoint and i < self.checkpoint_num[2]:
                    x = checkpoint.checkpoint(blk, x)
                else:
                    x_4, x_8, x = blk(x_4, x_8, x, True)
            x_4, x_8, x = self.patch_embed4(x_4, x_8, x, True)
            for i, blk in enumerate(self.blocks4):
                if self.use_checkpoint and i < self.checkpoint_num[3]:
                    ...
                    x_4, x_8, x = blk(x_4, x_8, x, True)
            x_4 = self.norm_4(x_4)
            x_4 = self.pre_logits(x_4)
            
            x_8 = self.norm_8(x_8)
            x_8 = self.pre_logits(x_8)
            ...
            if x_4 is not None:
                x = self.patch_embed1(x_4, None, None, False)
                x = self.pos_drop(x)
                for i, blk in enumerate(self.blocks1):
                    if self.use_checkpoint and i < self.checkpoint_num[0]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
                        x = blk(x, None, None, False)
                x = self.patch_embed2(x, None, None, False)
                for i, blk in enumerate(self.blocks2):
                    if self.use_checkpoint and i < self.checkpoint_num[1]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
                        x = blk(x, None, None, False)
                x = self.patch_embed3(x, None, None, False)
                for i, blk in enumerate(self.blocks3):
                    if self.use_checkpoint and i < self.checkpoint_num[2]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
                        x = blk(x, None, None, False)
                x = self.patch_embed4(x, None, None, False)
                for i, blk in enumerate(self.blocks4):
                    if self.use_checkpoint and i < self.checkpoint_num[3]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
                ...
                x = self.patch_embed1(None, x_8, None, False)
                x = self.pos_drop(x)
                for i, blk in enumerate(self.blocks1):
                    if self.use_checkpoint and i < self.checkpoint_num[0]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
                        x = blk(None, x, None, False)
                x = self.patch_embed2(None, x, None, False)
                for i, blk in enumerate(self.blocks2):
                    if self.use_checkpoint and i < self.checkpoint_num[1]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
                        x = blk(None, x, None, False)
                x = self.patch_embed3(None, x, None, False)
                for i, blk in enumerate(self.blocks3):
                    if self.use_checkpoint and i < self.checkpoint_num[2]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
                        x = blk(None, x, None, False)
                x = self.patch_embed4(None, x, None, False)
                for i, blk in enumerate(self.blocks4):
                    if self.use_checkpoint and i < self.checkpoint_num[3]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
                ...
                x = self.patch_embed1(None, None, x, False)
                x = self.pos_drop(x)
                for i, blk in enumerate(self.blocks1):
                    if self.use_checkpoint and i < self.checkpoint_num[0]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
                        x = blk(None, None, x, False)
                x = self.patch_embed2(None, None, x, False)
                for i, blk in enumerate(self.blocks2):
                    if self.use_checkpoint and i < self.checkpoint_num[1]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
                        x = blk(None, None, x, False)
                x = self.patch_embed3(None, None, x, False)
                for i, blk in enumerate(self.blocks3):
                    if self.use_checkpoint and i < self.checkpoint_num[2]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
                        x = blk(None, None, x, False)
                x = self.patch_embed4(None, None, x, False)
                for i, blk in enumerate(self.blocks4):
                    if self.use_checkpoint and i < self.checkpoint_num[3]:
                        x = checkpoint.checkpoint(blk, x)
                    else:
    ...
    def forward(self, x_4, x_8, x, training=True):
        if training == True:
            x_4, x_8, x = self.forward_features(x_4, x_8, x, True)
            x_4 = x_4.flatten(2).mean(-1)
            x_8 = x_8.flatten(2).mean(-1)
            ...
            if x_4 is not None:
                x = self.forward_features(x_4, None, None, False)
                x = x.flatten(2).mean(-1)
                x = self.head(x)
            elif x_8 is not None:
                x = self.forward_features(None, x_8, None, False)
                x = x.flatten(2).mean(-1)
                x = self.head(x)
            elif x is not None:
                x = self.forward_features(None, None, x, False)
                x = x.flatten(2).mean(-1)
                x = self.head(x)
